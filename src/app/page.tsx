      ...
      <div className="flex-1">
          ...
          <div className="cal-container">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              <div className="lg:col-span-5 space-y-6">
                ...
                <p className="cal-body text-muted">
              ...
              <div className="lg:col-span-7">
                <div className="cal-mockup-card">
                  ...
                  <div className="flex items-center justify-between pb-4 border-b border-hairline mb-6">
                    ...
                    <div className="flex items-center gap-2 bg-surface-soft border border-hairline px-3 py-1 rounded-md text-[11px] text-muted font-mono">
                    ...
                    <div className="flex items-center justify-between p-4 rounded-lg border border-hairline bg-canvas hover:border-surface-strong transition-colors duration-200">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="cal-caption text-muted">Vercel · Remote · Full-time</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
                        ...
                        <span className="cal-caption text-muted font-mono">$140k - $170k</span>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between p-4 rounded-lg border border-hairline bg-canvas hover:border-surface-strong transition-colors duration-200">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="cal-caption text-muted">Stripe · San Francisco · Hybrid</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="cal-badge-pill cal-badge-pill-emerald">
                        ...
                        <span className="cal-caption text-muted font-mono">$150k - $185k</span>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between p-4 rounded-lg border border-hairline bg-canvas hover:border-surface-strong transition-colors duration-200">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="cal-caption text-muted">Linear · Remote · Contract</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
                        ...
                        <span className="cal-caption text-muted font-mono">$120k - $145k</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="cal-mockup-card">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
                    ...
                    <div className="md:col-span-5 flex flex-col items-center justify-center p-4 border border-hairline rounded-lg bg-surface-soft text-center">
                      <div className="relative size-28 flex items-center justify-center mb-3">
                        ...
                        <div className="absolute flex flex-col items-center justify-center">
                          ...
                          <span className="cal-caption text-muted uppercase tracking-wider">ATS Score</span>
                        </div>
                      </div>
                    ...
                    <div className="md:col-span-7 space-y-3">
                      <h5 className="cal-caption text-muted uppercase tracking-wider font-mono">Key Enhancements</h5>
                      ...
                      <div className="flex items-start gap-3 p-4 rounded-lg border border-hairline bg-canvas">
                        ...
                        <div>
                          ...
                          <p className="cal-body-sm text-muted mt-1">Keywords match 90% of job description density.</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3 p-4 rounded-lg border border-hairline bg-canvas">
                        ...
                        <div>
                          ...
                          <p className="cal-body-sm text-muted mt-1">Replace &ldquo;responsible for&rdquo; with &ldquo;designed and deployed&rdquo;.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                    ...
                    <div className="md:col-span-5 space-y-3 p-4 border border-hairline rounded-lg bg-canvas">
                      <div className="space-y-1.5">
                        <label className="cal-caption text-muted uppercase tracking-wider font-mono">Company Name</label>
                        <div className="cal-input bg-surface-soft border-hairline text-ink font-normal">Google</div>
                      </div>
                      <div className="space-y-1.5">
                        <label className="cal-caption text-muted uppercase tracking-wider font-mono">Target Role</label>
                        <div className="cal-input bg-surface-soft border-hairline text-ink font-normal">React Developer</div>
                      </div>
                      <div className="space-y-1.5">
                        <label className="cal-caption text-muted uppercase tracking-wider font-mono">Voice Tone</label>
                        <div className="cal-input bg-surface-soft border-hairline text-ink font-mono">Direct & Persuasive</div>
                      </div>
                    </div>

                    {/* Live Paper Preview */}
                    <div className="md:col-span-7 bg-canvas border border-hairline p-4 rounded-lg font-mono text-sm leading-relaxed text-muted max-h-[160px] overflow-y-auto">
                ...
                <div className="cal-mockup-card">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    <div className="p-4 border border-hairline rounded-lg bg-surface-soft">
                      <span className="cal-caption text-muted uppercase tracking-wider font-mono block mb-1">Average Salary</span>
                    ...
                    <div className="p-4 border border-hairline rounded-lg bg-surface-soft">
                      <span className="cal-caption text-muted uppercase tracking-wider font-mono block mb-1">Active Roles</span>
                      <div className="flex items-baseline gap-2">
                  ...
                  <div className="border border-hairline p-4 rounded-lg bg-surface-soft">
                    <span className="cal-caption text-muted uppercase tracking-wider font-mono block mb-4">Frontend Salary by Experience</span>
                    <div className="h-24 w-full flex items-end justify-between px-2 pt-2 relative">
                      ...
                      <div className="w-10 bg-canvas hover:bg-surface-soft border border-hairline h-[25%] rounded-t flex items-center justify-center cal-caption text-muted font-mono">Entry</div>
                      <div className="w-10 bg-canvas hover:bg-surface-soft border border-hairline h-[45%] rounded-t flex items-center justify-center cal-caption text-muted font-mono">Mid</div>
                      <div className="w-10 bg-canvas hover:bg-surface-soft border border-hairline h-[70%] rounded-t flex items-center justify-center cal-caption text-muted font-mono">Senior</div>
          ...
          <div className="cal-container">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              <div className="lg:col-span-5 space-y-6">
                ...
                <div className="pt-2">
                  <Link href="/visual-whiteboard" className="cal-button-secondary inline-flex items-center gap-2">
                    Open Visual Tracker
                    <ArrowRight className="size-4" />
                  </Link>
                </div>
              ...
              <div className="lg:col-span-7">
                <div className="cal-mockup-card">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {/* Column 1: Wishlist */}
                    <div className="space-y-2 p-3 border border-hairline rounded-lg bg-canvas min-h-[140px]">
                      <span className="cal-caption text-muted uppercase tracking-wider font-mono block mb-1">Wishlist (2)</span>
                      <div className="p-3 border border-hairline rounded-md bg-surface-soft">
                        <span className="cal-badge-pill cal-badge-pill-emerald text-[10px] mb-1">Google</span>
                        <h5 className="cal-title-sm text-ink">React Lead</h5>
                      </div>
                      <div className="p-3 border border-hairline rounded-md bg-surface-soft opacity-60">
                        <span className="cal-badge-pill text-[10px] mb-1">Amazon</span>
                        <h5 className="cal-title-sm text-muted">Full Stack</h5>
                      </div>
                    </div>

                    {/* Column 2: Applied */}
                    <div className="space-y-2 p-3 border border-hairline rounded-lg bg-canvas min-h-[140px]">
                      <span className="cal-caption text-muted uppercase tracking-wider font-mono block mb-1">Applied (1)</span>
                      <div className="p-3 border border-hairline rounded-md bg-surface-soft">
                        <span className="cal-badge-pill text-[10px] mb-1">Vercel</span>
                        <h5 className="cal-title-sm text-ink">Next Developer</h5>
                      </div>
                    </div>

                    {/* Column 3: Interview */}
                    <div className="space-y-2 p-3 border border-hairline rounded-lg bg-canvas min-h-[140px]">
                      <span className="cal-caption text-muted uppercase tracking-wider font-mono block mb-1">Interview (1)</span>
                      <div className="p-3 border border-brand-accent rounded-md bg-brand-accent/5">
                        <span className="cal-badge-pill cal-badge-pill-violet text-[10px] mb-1">Stripe</span>
                        <h5 className="cal-title-sm text-ink">Frontend Infra</h5>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <section className="cal-cta-band mx-auto max-w-[1200px] px-6 mb-[96px]">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="cal-body text-muted mb-8">
